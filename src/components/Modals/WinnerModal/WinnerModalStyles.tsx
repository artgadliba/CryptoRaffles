...
const WinnerModalBlock = styled.div`
  width: 100%;
  height: 100%;
  position: fixed;
  left: 0;
...
const WinnerModalContent = styled.div`
  display: flex;
...
const WinnerModalClose = styled.button`
  cursor: pointer;
...
const WinnerModalLine = styled.div`
  width: ${pxIntoRem(253)};
  height: ${pxIntoRem(2)};
...
const WinnerModalText = styled.p`
  font-family: "Gilroy";
  font-style: normal;
  font-weight: 600;
...
const WinnerModalButton = styled.button`
  font-family: "Gilroy";
  font-style: normal;
  font-weight: 600;
...
const WinnerModalLines = styled.img`
  width: ${pxIntoRem(470)};
...
const WinnerModalHoliday = styled.img`
  position: absolute;
  top: ${pxIntoRem(60)};
  right: 0px;
  width: ${pxIntoRem(367)};
...
export { WinnerModalBlock, WinnerModalClose, WinnerModalContent, WinnerModalCloseImage, WinnerModalButton, WinnerModalLine, WinnerModalSumm, WinnerModalText, WinnerModalLines, WinnerModalHoliday };
